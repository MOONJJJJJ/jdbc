...
class MemberServiceV1Test {
    ...
    void accountTransfer() throws SQLException{
        ...
        org.assertj.core.api.Assertions.assertThat(findMemberB.getMoney()).isEqualTo(12000);
    ...
    void accountTransferEx() throws SQLException {
        ...
        org.assertj.core.api.Assertions.assertThat(findMemberA.getMoney()).isEqualTo(8000);
        org.assertj.core.api.Assertions.assertThat(findMemberEx.getMoney()).isEqualTo(10000);
    }
}